...
- combine consecutive user messages into single turn and throw error on empty replies
...
- upgrade to deepseek-v4-flash-vision-exp and add dynamic multimodal chat support
...
- auto align days locale on remote sync and persist copies to artifact store
...
- prevent cloud overwrite and destructive day resize on locale change
