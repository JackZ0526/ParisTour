    ...
    >
          ...
          {options.map((option) => (
            ...
            >
              <span className="min-w-0">
                ...
                <span className="mt-0.5 block text-xs leading-relaxed text-[var(--stone)]">
                  {option.description}
                </span>
              </span>
      ...
      <div className="flex flex-wrap justify-between gap-2 border-t border-[var(--mist)] px-5 py-4">
        <button
          ...
          className="rounded-full border border-[var(--stone)]/30 px-4 py-2 text-sm text-[var(--stone)] hover:border-[var(--sage)]"
        >
          恢复默认
        </button>
        <div className="flex gap-2">
          <button
            type="button"
            onClick={onClose}
            className="rounded-full border border-[var(--stone)]/30 px-4 py-2 text-sm"
          >
            取消
          </button>
          <button
