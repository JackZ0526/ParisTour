...
export function ProfileTab({
  ...
  return (
    ...
    >
      {/* ========================================================================= */}
      {/* 1. Top Card: Account Profile & Trip Health Stats (Full-Width Header Card) */}
      {/* ========================================================================= */}
      ...
      {/* ========================================================================= */}
      {/* 2. Responsive 2-Column Grid for Desktop (Left: Mgmt / Right: AI & Danger)  */}
      {/* ========================================================================= */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-start">
        {/* Left Column on Desktop: Trip Management & Multi-Trip Switcher */}
        ...
        {/* Right Column on Desktop: AI Preferences & Danger Zone */}
        <div className="space-y-4 lg:space-y-6">
